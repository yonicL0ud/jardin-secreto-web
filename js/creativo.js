/**
 * 🌸 ELEMENTO CREATIVO: "Flor del Día" 🌸
 * Muestra una flor diferente cada día según la fecha
 * y permite al usuario "regar" las plantas con animación
 */

// ========== 1. FLOR DEL DÍA (según fecha) ==========
...
// ========== 2. ANIMACIÓN DE "REGAU" (efecto creativo) ==========
...
function inicializarEfectoRiego() {
    // Al hacer clic sostenido (contextmenu) en cualquier tarjeta de producto
...
// ========== 3. MENSAJE SORPRESA (cada 5 visitas al carrito) ==========
...
// ========== 4. INICIALIZAR ELEMENTOS CREATIVOS ==========
